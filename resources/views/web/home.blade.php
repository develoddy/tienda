                                ...
                                <li>
                                    <a class="product-4-layout-view" href="#" data-original-title=""
                                        title=""><span class="line-grid line-grid-6 bg-primary"></span><span
                                            ...
                                            class="line-grid line-grid-9 bg-primary"></span></a>
                                </li>
                                <li>
                                    <a class="product-6-layout-view" href="#" data-original-title=""
                                        title=""><span class="line-grid line-grid-10 bg-primary"></span><span
                                            ...
                                            class="line-grid line-grid-15 bg-primary"></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="left-filter">
                                        <div class="card-body filter-cards-view animate-chk">
                                                    ...
                                                    <div class="item">
                                                        <div class="product-box row">
                                                            ...
                                                            <div class="product-details col-md-7 text-start">
                                                                <span><i class="fa fa-star font-warning me-1"></i><i
                                            ...
                                            <div class="product-filter text-center">
                                                <img class="img-fluid banner-product"
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/01.jpg') }}" alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            ...
                                            <li>
                                                <button class="btn" type="button">
                                                    <i class="icofont icofont-law-alt-2"></i>
                                                </button>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    <div class="product-img col-lg-6">
                                                        <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/01.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-qnty">
                                                            ...
                                                            <div class="addcart-btn">
                                                                <a class="btn btn-primary" href="cart.php" data-bs-original-title="" title="">Add to Cart</a>

                                                                <a class="btn btn-primary ms-2" href="{{ route('product') }}" data-bs-original-title="" title="">View Details</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    ...
                                    <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/02.jpg') }}" alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            <li>
                                                <button class="btn" type="button">
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    <div class="product-img col-lg-6">
                                                        <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/02.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <div class="product-details col-lg-6 text-start">
                                                        <h4>Woman T-shirt</h4>
                    ...
                    <div class="col-xl-3 col-sm-6 xl-4">
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/03.jpg') }}" alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            <li>
                                                <button class="btn" type="button">
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    <div class="product-img col-lg-6">
                                                        <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/03.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <div class="product-details col-lg-6 text-start">
                                                        <h4>Woman T-shirt</h4>
                        ...
                        <div class="card">
                            <div class="product-box">
                                <div class="product-img">
                                    ...
                                    <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/04.jpg') }}" alt="" />
                                    <div class="product-hover">
                                        <ul>
                                            <li>
                                                <button class="btn" type="button">
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    <div class="product-img col-lg-6">
                                                        <img class="img-fluid" src="{{ Vite::asset('/resources/images/ecommerce/04.jpg') }}"
                                                            alt="" />
                                                    </div>
                                                    <div class="product-details col-lg-6 text-start">
                                                        <h4>Woman T-shirt</h4>
        ...
        <div class="row">
            <div class="col-xl-3 col-sm-6 xl-4">
                <div class="card border-0">
                    <img src="{{ Vite::asset('/resources/images/ecommerce/01.jpg') }}" class="card-img-top" alt="...">
                    <div class="p-2">
                        <i>
                    ...
                    <div class="card-body">
                        <h5 class="card-title fw-bolder">Woman T-shirt</h5>
                        <p class="card-text text-secondary">Women Full Sleeve Printed Sweatshirt.</p>
                        <div class="d-flex flex-row">
                            <div class="">
                                <h5 class="text-primary fw-bolder">26.00 €</h5>
                            </div>
                            <div class="px-3 text-secondary">
                                <h5 class="text-secondary"><del><small>350.00 €</small></del></h5>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-sm-6 xl-4">
                <div class="card border-0">
                    <img src="{{ Vite::asset('/resources/images/ecommerce/02.jpg') }}" class="card-img-top" alt="...">
                    <div class="p-2">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-star-fill text-warning" viewBox="0 0 16 16">
            ...
            <div class="col-xl-3 col-sm-6 xl-4">
                <div class="card border-0">
                    <img src="{{ Vite::asset('/resources/images/ecommerce/03.jpg') }}" class="card-img-top"
                        alt="...">
                    <div class="p-2">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col-xl-3 col-sm-6 xl-4">
                <div class="card border-0">
                    <img src="{{ Vite::asset('/resources/images/ecommerce/04.jpg') }}" class="card-img-top"
                        alt="...">
                    <div class="p-2">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div class="col-xl-3 col-sm-6 xl-4">
                <div class="card border-0">
                    <img src="{{ Vite::asset('/resources/images/ecommerce/02.jpg') }}" class="card-img-top"
                        alt="...">
                    <div class="p-2">
                        <i>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
